...
export const OVERRIDE_GRAPH_NAME = process.env.NEXT_PUBLIC_GRAPH_NAME;

export const OVERRIDE_GRAPH_BASE_URL = process.env.NEXT_PUBLIC_GRAPH_BASE_URL;
export const OVERRIDE_GRAPH_NAMESPACE = process.env.NEXT_PUBLIC_GRAPH_NAMESPACE;
