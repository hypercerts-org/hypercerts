[Hypercerts SDK Documentation](../README.md) / [Exports](../modules.md) / utils/config
...
[sdk/src/utils/config.ts:10](https://github.com/Network-Goods/hypercerts/blob/29cf555/sdk/src/utils/config.ts#L10)
