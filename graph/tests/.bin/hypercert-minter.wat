(module
  ...
  (func $~lib/@graphprotocol/graph-ts/common/collections/ByteArray.fromI32 (type 0) (param i32) (result i32)
    ...
    call $~lib/typedarray/Uint8Array#__set
    local.get 1)
  (func $~lib/@graphprotocol/graph-ts/common/numbers/BigInt.fromI64 (type 7) (param i64) (result i32)
    (local i32)
    i32.const 8
    call $~lib/@graphprotocol/graph-ts/common/collections/ByteArray#constructor
    local.tee 1
  ...
  (func $~lib/@graphprotocol/graph-ts/common/value/Value#displayData (type 0) (param i32) (result i32)
    ...
    i32.const 3136
    call $~lib/util/string/joinStringArray)
  (func $generated/schema/Claim#save (type 9) (param i32)
    (local i32 i32)
    block (result i32)  ;; label = @1
      local.get 0
      local.set 1
  ...
  (func $~lib/@graphprotocol/graph-ts/common/collections/Entity#unset (type 2) (param i32 i32)
    ...
    local.get 2
    call $~lib/@graphprotocol/graph-ts/common/collections/TypedMap<~lib/string/String_~lib/@graphprotocol/graph-ts/common/value/Value>#set)
  (func $start:tests/hypercert-minter.test~anonymous|0~anonymous|0 (type 4)
    ...
    local.get 1
    call $generated/schema/Claim#save)
  (func $start:tests/hypercert-minter.test~anonymous|0~anonymous|1 (type 4)
  ...
  (func $start:tests/hypercert-minter.test~anonymous|0~anonymous|2 (type 4)
    (local i32)
    i32.const 1
    i32.const 3168
    ...
    i32.const 7648
    call $~lib/matchstick-as/assembly/assert/assert.fieldEquals)
  (func $start:tests/hypercert-minter.test~anonymous|0 (type 4)
    i32.const 7072
    i32.load
    i32.const 7104
  ...
  (elem $0 (i32.const 1) func $~lib/@graphprotocol/graph-ts/common/value/Value#displayData~anonymous|0 $start:tests/hypercert-minter.test~anonymous|0~anonymous|0 $start:tests/hypercert-minter.test~anonymous|0~anonymous|1 $start:tests/hypercert-minter.test~anonymous|0~anonymous|2 $start:tests/hypercert-minter.test~anonymous|0)
  ...
  (data (;161;) (i32.const 7320) "\01\00\00\00\1e\00\00\00A\00s\00s\00e\00r\00t\00i\00o\00n\00 \00E\00r\00r\00o\00r")
  (data (;162;) (i32.const 7372) "\5c")
  (data (;163;) (i32.const 7384) "\01\00\00\00J\00\00\00~\00l\00i\00b\00/\00m\00a\00t\00c\00h\00s\00t\00i\00c\00k\00-\00a\00s\00/\00a\00s\00s\00e\00m\00b\00l\00y\00/\00a\00s\00s\00e\00r\00t\00.\00t\00s")
  (data (;164;) (i32.const 7468) ",")
  (data (;165;) (i32.const 7480) "\01\00\00\00\1a\00\00\00C\00l\00a\00i\00m\00F\00r\00a\00c\00t\00i\00o\00n")
  (data (;166;) (i32.const 7516) "l")
  (data (;167;) (i32.const 7528) "\01\00\00\00T\00\00\000\00x\00a\001\006\000\008\001\00f\003\006\000\00e\003\008\004\007\000\000\006\00d\00b\006\006\000\00b\00a\00e\001\00c\006\00d\001\00b\002\00e\001\007\00e\00c\002\00a")
  (data (;168;) (i32.const 7628) "\1c")
  (data (;169;) (i32.const 7640) "\01\00\00\00\0a\00\00\001\000\000\000\000")
  (data (;170;) (i32.const 7660) "\1c")
  (data (;171;) (i32.const 7672) "\22\00\00\00\08\00\00\00\04")
  (data (;172;) (i32.const 7692) "\1c")
  (data (;173;) (i32.const 7704) "\22\00\00\00\08\00\00\00\05")
  (data (;174;) (i32.const 7724) "<")
  (data (;175;) (i32.const 7740) " \00\00\00\a0\04\00\00\c0\04\00\00\e0\04\00\00\10\05\00\000\05\00\00P\05\00\00p\05\00\00\90\05")
  (data (;176;) (i32.const 7788) ",")
  (data (;177;) (i32.const 7800) "\03\00\00\00\10\00\00\00@\1e\00\00@\1e\00\00 \00\00\00\08"))
