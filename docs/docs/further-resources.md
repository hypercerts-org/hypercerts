...
* Feb XX, 2023, Whitepaper draft by [@hypercerts](http://twitter.com/hypercerts): [Hypercerts: A new primitive for impact funding systems (draft v0)](../static/pdf/docs/static/pdf/2023-02-14_hypercerts_a_new_primitive_for_impact_funding_systems_v0.pdf)
